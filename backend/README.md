...
## Project Structure
    ...
    ├── testapiautostoryboa_55729  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_55729`
...
2. Clone this repo and `cd testapiautostoryboa_55729`
